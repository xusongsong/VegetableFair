...
<div id="spjk" class="alltk"><!--视频监控-->
		<div class="map_ss_tk">
			<ul class="sdsc_tk_top">
				<span style="margin-left: 10px; font-size: 14px;" id = "videoParent"><strong></strong></span>
				<!--<span style="margin-left: 20px;color: #b7b7b7;">详情>></span>-->
				<span class="qy_gb" id = "videoCancle"></span>
			</ul>
			<ul class="q_xq">
				<li class="q_xq_lb">
					<span style="width: 55%;" id = "videoName"></span>
					<span style="width: 45%;" id = "videoNo"></span>
				</li>
				 <li class="q_xq_lb">
					<span style="width: 55%;" id = "videoType"></span>
					<span style="width: 45%;" id = "videoLat"></span>
				</li> 
				<li class="yl_btn" id = "preview" ><span>预览</span></li>
			</ul>
		</div>
